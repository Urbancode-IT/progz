...
const StudentViewProgress = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-200 to-gray-400 flex items-center justify-center p-4">
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-200 to-gray-400 flex items-center justify-center p-4">
        <div className="bg-white p-6 rounded-xl shadow-lg w-full max-w-md">
          ...
          <button 
            onClick={() => navigate(-1)}
            className="mt-4 px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors w-full sm:w-auto"
          >
            Go Back
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-200 to-gray-400 py-4 sm:py-8 px-3 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-6xl mx-auto">
        <div className="bg-white shadow-xl overflow-hidden rounded-lg sm:rounded-xl">
          {/* Header */}
          <div className="bg-gradient-to-r from-purple-600 to-blue-600 px-4 py-3 sm:px-6 sm:py-4">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
              <div className="max-w-full overflow-hidden">
                ...
                <p className="text-purple-100 text-sm sm:text-base mt-1 font-light">Your Progress</p>
              </div>
              <button
                onClick={() => navigate(-1)}
                className="text-white hover:text-purple-200 transition-colors self-end sm:self-auto"
                aria-label="Go back"
              >
          ...
          <div className="p-4 sm:p-6 lg:p-8">
            ...
            <div className="mb-6 p-3 sm:p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex items-center">
                <div className="bg-purple-100 text-purple-800 rounded-full p-2 sm:p-3 mr-3 sm:mr-4">
                ...
                <div className="truncate">
                  <p className="font-medium truncate">{progressData.instructor}</p>
                </div>
              </div>
            </div>
            ...
            {/* Progress Modules */}
            <div className="mb-8">
              <h2 className="text-xl font-semibold mb-4 text-gray-800 border-b pb-2">Your Progress</h2>
              <div className="mb-6">
                <h2 className="text-xl sm:text-2xl font-bold mb-2">Course Progress</h2>
                <div className="w-full bg-gray-300 rounded-full h-4 sm:h-6">
                  <div
                    className="bg-green-600 h-full text-white text-xs sm:text-sm font-semibold text-center rounded-full transition-all duration-300 flex items-center justify-center"
