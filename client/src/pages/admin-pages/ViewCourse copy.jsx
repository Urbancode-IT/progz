          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="flex flex-wrap gap-3 mb-8">
              {/* <button
                ...
                className="flex items-center px-4 py-2 bg-gradient-to-r from-green-400 to-teal-400 text-white rounded-lg shadow hover:from-green-500 hover:to-teal-500 transition-colors"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <button
                ...
                className="flex items-center px-4 py-2 bg-gradient-to-r from-blue-400 to-indigo-400 text-white rounded-lg shadow hover:from-blue-500 hover:to-indigo-500 transition-colors"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5 mr-2"
              ...
              <button
                ...
                className="flex items-center px-4 py-2 bg-gradient-to-r from-red-400 to-pink-400 text-white rounded-lg shadow hover:from-red-500 hover:to-pink-500 transition-colors"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5 mr-2"
            ...
            {/* Modules Section */}
            {/* Modules Section - Updated to show content in tables */}
            <div className="mb-8">
                      ...
                      {module.sections?.length > 0 && (
                        <div className="space-y-6">
                          {module.sections.map((section, sIdx) => (
                            ...
                            >
                              <h4 className="font-medium text-lg text-gray-800 mb-4 border-b pb-2">
    ...
    <>
      ...
      <div className="flex justify-end gap-2">
        ...
        <button
          ...
          className="px-4 py-2 border border-transparent rounded-lg text-sm font-medium text-white bg-gradient-to-r from-red-600 to-pink-600 hover:from-red-700 hover:to-pink-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
        >
          Delete Course
        </button>
      </div>
